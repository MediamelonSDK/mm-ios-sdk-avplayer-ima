...
@objc public class AVPlayerIntegrationWrapper: NSObject { //ENABLE SSAI
    ...
    private static let KPlaybackPosPollingIntervalMSec = 1000
    ...
    private override init() {
        ...
        sdkVersion = coreSDK + IMASDK + "_AV_" + GenericMMWrapper.shared.getCoreSDKVersion() + ".6.1"
        super.init()
    }
    ...
    private func reset() {
        ...
        self.currentBufferState = CurrentBufferingState.IDLE
        self.seekState = Seek.IDLE
